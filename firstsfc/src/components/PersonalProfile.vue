<template>
  <div class="html">
        ...
        <title>Jonathan Mark Agbulos | Profile</title>
        ...
        <style>
            ...
            /* Moved inline styles here for cleaner HTML */
            .contact-field { width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.2); padding: 0.75rem; color: #fff; margin-bottom: 1rem; }
            .contact-btn { background: transparent; border: 1px solid #fff; color: #fff; padding: 0.5rem 2rem; cursor: pointer; text-transform: uppercase; font-size: 0.7rem; letter-spacing: 0.2rem; transition: 0.3s; }
            .contact-btn:disabled { opacity: 0.5; cursor: not-allowed; }
            .separator { list-style: none; height: 1px; }
        </style>
    </head>
    <body>
        <div id="bg"></div>
        ...
        <div id="wrapper">
            <header id="header">
                ...
                <ul class="icons">
                    <li><a href="https://linkedin.com/in/dyonasito"><i class="fa-brands fa-linkedin"></i><span class="label">LinkedIn</span></a></li>
                    <li><a href="https://facebook.com/dyonasito"><i class="fa-brands fa-facebook"></i><span class="label">Facebook</span></a></li>
                    <li><a href="https://instagram.com/dyonasito/"><i class="fa-brands fa-instagram"></i><span class="label">Instagram</span></a></li>
                    <li><a href="https://github.com/Johanoss"><i class="fa-brands fa-github"></i><span class="label">GitHub</span></a></li>
                    <li class="separator"></li>
                    <li><a href="resources.html"><i class="fa-regular fa-file-lines"></i><span class="label">Resources</span></a></li>
                </ul>
                ...
                <div id="contact-app">
                    <transition name="fade">
                        <form v-if="!submitted" @submit.prevent="submitForm">
                            ...
                            <div class="field">
                                <label class="label" style="display:none">Name</label>
                            ...
                            <div class="field">
                                <label class="label" style="display:none">Message</label>
                        ...
                        <div v-else class="success-message" style="padding: 1.5rem; border: 1px solid rgba(255,255,255,0.2); background: rgba(255,255,255,0.05);">
                            <p style="font-size: 0.9rem; margin: 0;">✨ Thank you, {{ formData.name }}! I'll get back to you at {{ formData.email }} soon.</p>
                        </div>
                    </transition>
                </div>
            </header>
            ...
            <div id="main" style="display:none;">
                <article id="intro">
                    <h2 class="major">
                        About Me 
                        <span class="close" onclick="closeArticle()"><i class="fa-solid fa-xmark"></i></span>
                    </h2>
                ...
                <article id="projects">
                    <h2 class="major">My Projects<span class="close" onclick="closeArticle()"><i class="fa-solid fa-xmark"></i></span></h2>
                    <div class="project">
                        <table>
                            <thead>
                                <tr>
                ...
                <article id="gallery">
                    <h2 class="major">Gallery<span class="close" onclick="closeArticle()"><i class="fa-solid fa-xmark"></i></span></h2>
                    <div class="gallery">
